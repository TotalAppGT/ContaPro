  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (result.needsRegister) {
        navigate('/register', { state: { googleData: result } });
      } else {
        navigate('/app');
      }
    } catch (err) {
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-sm"><span className="bg-gray-50 px-3 text-gray-500">o</span></div>
            </div>
            <Button type="button" variant="outline" className="w-full" size="lg" onClick={handleGoogleLogin} disabled={isSubmitting}>
